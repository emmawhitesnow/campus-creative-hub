  ...
  head: () => ({
    meta: [
      ...
      { title: "Maren Ellis — Designer & Illustrator" },
      {
        name: "description",
        content:
          "Portfolio and print shop of Maren Ellis, a designer and illustrator making editorial work and warm, hand-drawn prints on campus.",
      },
      { name: "author", content: "Maren Ellis" },
    ],
    links: [
